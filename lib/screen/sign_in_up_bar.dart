    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Center(child: _LoadingIndicator(isLoading: isLoading),
            ),
          ),
...
Widget build(BuildContext) {
  return ConstrainedBox(
    ...
    child: Visibility(
      visible: isLoading,
      child: const LinearProgressIndicator(backgroundColor: Palette.blueGrey
      ),
    )
  );
}
